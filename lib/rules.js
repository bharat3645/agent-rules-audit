...
const INVISIBLE_RE = new RegExp("[" + String.fromCharCode(0x200b) + "-" + String.fromCharCode(0x200d) + String.fromCharCode(0xfeff) + String.fromCharCode(0x00ad) + String.fromCharCode(0x2060) + "]");
const BIDI_RE = new RegExp("[" + String.fromCharCode(0x202a) + "-" + String.fromCharCode(0x202e) + String.fromCharCode(0x2066) + "-" + String.fromCharCode(0x2069) + "]");
