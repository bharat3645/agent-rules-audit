# Contributing to agent-rules-audit
...
CI runs the same command plus a self-scan (this repo must grade A) and an end-to-end SARIF smoke; green CI is required, no exceptions (including for maintainers — check the history: it's how the whole repo was built).
